...
LastEditTime: 2021-01-05 21:58:24
'''
...
TIMESTAMP = "{0:%Y-%m-%dT%H/}".format(datetime.now())
...
for epoch in range(1, cfg.num_epoch+1):
    ...
    if (sacc > exprate):
        ...
        torch.save(encoder.state_dict(), 'checkpoints/encoder_posAware.pkl')
        torch.save(decoder.state_dict(), 'checkpoints/attn_decoder_posAware.pkl')
        print("done")
    else:
